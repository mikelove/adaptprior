...
## Alternative adaptive priors with fat tails
...
>     - use data $Y_g$, fixed parameters $\theta_g$, data likelihood
>     - return the posterior mode, posterior SD with Laplace approximation

## Connection to `bayesglm`

insert quotes from paper
...
* C++ implementation of L-BFGS-B to obtain posterior mode (1)
* `optim` to obtain Hessian for Laplace approximation (2)
* (1) takes fraction of second, (2) takes ~3 seconds
* Output posterior mode, SD, profile posterior intervals

## Estimate scale of prior (apeglm)

show Efron Morris eqns

## Scale of prior (apeglm)

show diagrams

## Yeast with Normal prior (3 vs 3)
...
* [apeglm preprint](https://doi.org/10.1101/303255)
